...
object TopicMockData {
    ...
    fun topicDetail(id: String = "5192"): TopicDetailEntity = TopicDetailEntity(
        list = listOf(
            TopicDetailEntity.BannerBean(image = "https://picsum.photos/id/1015/640/360", text = "春日灵感"),
            TopicDetailEntity.BannerBean(image = "https://picsum.photos/id/1025/640/360", text = "材质之美"),
            TopicDetailEntity.BannerBean(image = "https://picsum.photos/id/1039/640/360", text = "慢生活")
        ),
        name = "精选专题",
        tagid = id
    )
