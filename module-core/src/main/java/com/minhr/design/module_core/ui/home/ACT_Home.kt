...
import com.minhr.design.module_core.bean.MainTabEntity
...
class ACT_Home : BaseActivity<BaseContract.BasePresenter, BaseContract.BaseModel>() {
    private val tabLayout by bindView<CommonTabLayout>(R.id.tabLayout)
    ...
    // 默认进入「发现」(开眼接口仍可用)；想去/设计师/逛依赖的 api.xiangqu.com 已下线
