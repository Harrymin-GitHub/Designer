...
object DesignerMockData {
    ...
    fun recommendDesigner(): DesignerEntity = DesignerEntity(
        ...
        userNick = "草木",
        banner = "https://picsum.photos/id/1015/960/645",
        opTag = "品牌创始人、设计师",
        shopName = "软语 金银细软珠宝店",
        shopId = "70wv8vnw"
    )
    ...
    fun designerList(): List<DesignerEntity> = listOf(
        ...
        DesignerEntity(
            ...
            userNick = "青禾",
            banner = "https://picsum.photos/id/1025/960/645",
            opTag = "独立设计师",
            shopName = "青禾工作室",
            shopId = "shop2"
        ),
        DesignerEntity(
            ...
            userNick = "白川",
            banner = "https://picsum.photos/id/1039/960/645",
            opTag = "生活美学设计师",
            shopName = "白川家居",
            shopId = "shop3"
        ),
        DesignerEntity(
            ...
            userNick = "纸间",
            banner = "https://picsum.photos/id/1060/960/645",
            opTag = "文创设计师",
            shopName = "纸间造物",
            shopId = "shop4"
        )
    ...
    private fun tag(categoryId: String, id: String, name: String, photoId: Int) =
        TagCategoryEntity.TagBean(
            ...
            id = id,
            image = "https://picsum.photos/id/$photoId/320/320",
            name = name
        )
}