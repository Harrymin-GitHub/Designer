...
import com.minhr.design.module_discover.adapter.ADA_Category
import com.minhr.design.module_discover.adapter.ADA_CategoryDetail
...
class FRA_CategoryDetail : BaseFragment<CategoryPresenter, CategoryModel>(), CategoryContract.View {
    private val rv by bindView<LRecyclerView>(R.id.rv)
